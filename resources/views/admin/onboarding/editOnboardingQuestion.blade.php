                ...
                <div class="card-header">Detail Quiz </div>
                    ...
                    <form action="/onboarding/updateQuiz/{{$data->id}}" method= "POST">
                        ...
                        <div class="form-group"> 
                            ...
                            <input class="form-control my-2" name="title" type="text" placeholder="Judul" id="title" value = "{{old('title')}}">
                        </div>
                        @error('title')
                        ...
                        <div class="form-group"> 
                            ...
                            <input class="form-control my-2" name="description" type="text" placeholder="Deskripsi Quiz" id="description" value = "{{old('description')}}">
                        </div>
                        <div class="form-group"> 
